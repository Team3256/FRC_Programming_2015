...
public class Constants {
	...
	public static final int LEFT_REAR_PORT = 3;
	public static final int RIGHT_FRONT_PORT = 0;
	public static final int RIGHT_REAR_PORT = 2;
	...
	public static final int ELEVATOR_ENCODER_PORT_1 = 8;
	public static final int ELEVATOR_ENCODER_PORT_2 = 9;
	...
	public static final int ELEVATOR_MOTOR_PORT_2 = 4;
